...
public class CylinderTest {
	...
	public void testSurfaceArea2() {
		Cylinder cylinder = new Cylinder(50, 75);
	...
	public void testSurfaceArea3() {
		Cylinder cylinder = new Cylinder(9.567f, 2.456f);
	...
	public void testVolume2() {
		Cylinder cylinder = new Cylinder(25, 99.50f);
	...
	public void testVolume3() {
		Cylinder cylinder = new Cylinder(4.275f, 15.600f);
	...
	public void testCylinder1() {
		...
		Cylinder cylinder = new Cylinder(575.25f, 1);
	...
	public void testGetHeight() {
		Cylinder cylinder = new Cylinder(1, 575.25f);
