...
public class CuboidTest {
	...
	public void testSurfaceArea3() {
		Cuboid cuboid = new Cuboid(5.5f, 8.97f, 2.2f);
	...
	public void testVolume1() {
		Cuboid cuboid = new Cuboid(5, 10, 4);
	...
	public void testVolume3() {
		Cuboid cuboid = new Cuboid(6.75f, 10.6f, 4.94f);
	...
	public void testCuboid1() {
		...
		Cuboid cuboid = new Cuboid(100, 1, 1);
	...
	public void testGetWidth() {
		Cuboid cuboid = new Cuboid(10, 1, 1);
	...
	public void testGetHeight() {
		Cuboid cuboid = new Cuboid(1, 10, 1);
	...
	public void testGetDepth() {
		Cuboid cuboid = new Cuboid(1, 1, 10);
